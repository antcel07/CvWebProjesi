...
<body>
    <div class="sidenav text-center">
        <div class="side_top">
            ...
            <h1 class="top_hd mt-2"><a href="index.html">Kerem Çelik</a></h1>
            <p class="top_hdp mt-2">Bilgisayar Mühendisi & Öğrenci</p>
        </div>
        <!-- header -->
        <header>
            <div class="nav-top">
            ...
            <div class="contact_grid_right mt-5 mx-auto text-left">
                <form action="#" method="post" runat="server">
                    <div class="row contact_top">
                        <div class="col-sm-6">
                            <asp:TextBox ID="TextBox1" placeholder="Adınız"  runat="server" ></asp:TextBox>
                        </div>
                        <div class="col-sm-6">
                             <asp:TextBox ID="TextBox2" placeholder="Mail Adresiniz"  runat="server" ></asp:TextBox>
                        </div>
                    </div>
                     <asp:TextBox ID="TextBox3" placeholder="Konu"  runat="server" ></asp:TextBox>
                     <asp:TextBox ID="TextBox4" placeholder="Mesajınız"  runat="server" TextMode="MultiLine" Height="50"></asp:TextBox>
